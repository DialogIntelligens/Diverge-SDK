    ...
    publications {
        register<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/DialogIntelligens/Diverge-SDK")
                licenses {
                    license {
                ...
                scm {
                    connection.set("scm:git:git://github.com/DialogIntelligens/Diverge-SDK.git")
                    developerConnection.set("scm:git:ssh://github.com/DialogIntelligens/Diverge-SDK.git")
                    url.set("https://github.com/DialogIntelligens/Diverge-SDK")
                }
            }
        }
